...
export function Camera({ withBackground = true, ...props }) {
    return (
        <Svg
            width={70}
            height={70}
...
export function Done(props) {
    return (
        ...
        >
            <Path
                d="M.817 5.06l5.58-.01 5.15 7.31 7-12.36h5.67l-11.7 18.56-1.95.04L.817 5.06z"
                fill="#43BD46"
            />
            <Path
                d="M11.357 6.95c.351.003.702.026 1.05.07l1.79-3.08a11.33 11.33 0 00-5.99.09l2 3a7.62 7.62 0 011.15-.08zm9.47 1.71l-2.09 3.19a7.999 7.999 0 01-9.306 10.853 8 8 0 01-6.074-7.753 7.82 7.82 0 01.35-2.33l-2.39-3a11.37 11.37 0 1019.51-1v.04z"
                fill="#97A1BF"
            />
        </Svg>
    )
